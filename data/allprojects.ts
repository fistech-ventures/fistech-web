...
{
  "smshome-luxury-aggregator": {
    // --- 1. CORE IDENTITY ---
    id: "p15", // Sequential ID following Instrufix
    slug: "smshome-luxury-aggregator",
    title: "SmsHome: Engineering a Neural Service Ecosystem for the UAE Luxury Market",
...
{
  "instrufix-hyperlocal-directory": {
    // --- 1. CORE IDENTITY ---
    id: "p14", // Sequential ID following RoyalHouseCheck
    slug: "instrufix-hyperlocal-directory",
    title: "Instrufix: Engineering Search Authority in the Music Service Economy",
    ...
    sections: [
      ...
      },
      {
        ...
        type: "solution",
        header: "The Fistech Engineering Solution: 'Architecture of Authority'",
        bodyText: "Our objective was to solve for both discoverability and trust. We engineered a scalable directory ecosystem where specialized skills are indexed with sub-second latency.",
        features: [
          { 
      ...
      },
      {
        ...
        type: "metrics",
        header: "Strategic ROI & Results",
        bodyText: "By 'Productizing' a fragmented service niche, we successfully positioned Instrufix as the primary digital authority for instrument maintenance.",
        stats: [
...
{
  "evpitch-neural-narrative": {
    // --- 1. CORE IDENTITY ---
    id: "p10",
    slug: "evpitch-neural-narrative",
    title: "EVPITCH: The Video-First Professional Network",
...
},
{
  "custom-coloring-books": {
    ...
    title: "Gen-AI Sketch Engine & Automated Publishing Pipeline",
    ...
    gallery: [
      {
        ...
        caption: "Performance-First Lead Interface: A custom React-powered estimator designed for maximum conversion with minimal user friction."
      },
      {
        url: "/images/localized-content-silos.jpg",
        caption: "Localized Content Silos: The architectural map of the Next.js SSR strategy, designed to dominate regional search markets."
      },
      {
        url: "/images/high-fidelity-asset-delivery.jpg",
        caption: "Visual Fidelity vs. Latency: Edge-cached project galleries delivering industrial-grade social proof without compromising mobile speed."
      }
    ],
    ...
    gallery: [
      {
        ...
        caption: "The Neural Interface: High-fidelity waveform analysis transforming raw 15-second audio into persistent digital personas."
      },
      {
        url: "/images/avatar-mapping-logic.jpg",
        caption: "Architecting Identity: Parametric mapping logic converting user photos into story-book-consistent character avatars."
      },
      {
        url: "/images/omnichannel-fulfillment.jpg",
        caption: "Omnichannel Fluidity: Automated transition from dynamic interactive viewers to 300-DPI print-ready CMYK layouts."
      }
    ],
    ...
    gallery: [
      {
        ...
        caption: "Precision UI Layering: A clinical, modern aesthetic engineered to foster immediate patient trust and professional authority."
      },
      {
        url: "/images/seamless-service-architecture.jpg",
        caption: "Seamless Service Architecture: High-conversion navigation logic that categorizes complex physiotherapy treatments into digestible, ROI-focused modules."
      },
      {
        url: "/images/enterprise-ready-infrastructure.jpg",
        caption: "Enterprise-Ready Infrastructure: Visualizing the high-performance Next.js deployment, ensuring a premium experience across all Western mobile device breakpoints."
      }
    ],
...
//       {
//         url: "/images/neural-interface-dashboard.jpg",
//         caption: "The Neural Interface: Showcasing the sophisticated waveform analysis dashboard where raw 15-second audio is vectorized into a persistent digital persona."
//       },
//       {
//         url: "/images/avatar-mapping-logic.jpg",
//         caption: "Architecting Identity: A demonstration of the parametric mapping logic that converts a single user photo into a consistent, story-book-ready character avatar."
//       },
//       {
//         url: "/images/omnichannel-fulfillment.jpg",
//         caption: "Omnichannel Fluidity: Visualizing the automated transition from a dynamic web-based interactive viewer to a professionally formatted, physical print layout."
//       }
//     ],
...
//           { 
//             title: "Parametric Identity Mapping", 
//             desc: "Backend logic mapping user-uploaded photos onto AI-generated character sets for seamless visual personalization." 
//           },
//           { 
//             title: "Asynchronous SSR Optimization", 
...
//           { 
//             title: "Automated Pre-Press Fulfillment", 
//             desc: "Node.js-driven engine converting dynamic content into 300-DPI, print-ready CMYK files, eliminating manual design overhead." 
//           }
//         ]
//       },
//       {
...
// },
{
  "braga-experience": {
    ...
    gallery: [
      {
        url: "/images/high-velocity-hero.jpg",
        caption: "High-Velocity Hero Interface: A masterclass in SSR optimization, delivering cinematic video backgrounds with zero-thread blocking.",
        logic: "Next.js Selective Hydration"
      },
      {
        url: "/images/precision-lead-gen.jpg",
        caption: "Precision Lead-Gen Architecture: A minimalist, Node.js-integrated conversion portal designed to capture high-value intent.",
        logic: "Asynchronous API Middleware"
      },
      {
        url: "/images/responsive-media-grid.jpg",
        caption: "Responsive Media Grid: A parametric layout engineered to maintain 60FPS scrolling while rendering high-bitrate visual portfolios.",
        logic: "Intelligent Lazy-Loading"
      }
    ],
...
},
{
  "vivtex": {
    ...
    gallery: [
      {
        url: "/images/precision-engineered-navigation.jpg",
        caption: "Precision-Engineered Navigation: High-fidelity UI hierarchy designed to lead global investors through complex research data with zero friction."
      },
      {
        url: "/images/fluid-data-visualization.jpg",
        caption: "Fluid Data Visualization: A scientific repository demonstrating how dense biological datasets are rendered with minimalist, high-speed Parametric Logic."
      },
      {
        url: "/images/global-performance-optimization.jpg",
        caption: "Global Performance Optimization: Visualizing sub-second load times achieved through Next.js optimization, ensuring a seamless experience for Tier-1 partners."
      }
    ],
...
},
{
  "providing-dial-tone": {
    ...
    gallery: [
      {
        url: "/images/architectural-authority.jpg",
        caption: "Architectural Authority: A high-contrast, professional interface designed to establish immediate credibility with institutional investors."
      },
      {
        url: "/images/performance-engineering.jpg",
        caption: "Performance Engineering: Leveraging Next.js for edge-latency reduction, ensuring the platform remains responsive across global markets."
      },
      {
        url: "/images/strategic-funneling.jpg",
        caption: "Strategic Funneling: The UI utilizes a sophisticated user journey that guides stakeholders from heritage storytelling to ROI-focused business inquiries."
      }
    ],
